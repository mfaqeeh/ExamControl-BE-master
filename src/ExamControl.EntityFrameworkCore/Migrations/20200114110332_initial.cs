        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    RankDesc = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    BookingDesc = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    ReasonDesc = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    CollegeName = table.Column<string>(maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    CRNID = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CRNs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    SessionDesc = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    MemberName = table.Column<string>(maxLength: 64, nullable: false),
                    MemberRankId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Colleges_CollegeId",
                        column: x => x.CollegeId,
                        principalTable: "Colleges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Members_AcademicRanks_MemberRankId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoSessions = table.Column<int>(nullable: false),
                    CollegeId = table.Column<int>(nullable: false),
                    AcademicRankId = table.Column<int>(nullable: false),
                    TermId = table.Column<int>(nullable: false),
                    CRNId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObserveSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObserveSettings_AcademicRanks_AcademicRankId",
                        column: x => x.AcademicRankId,
                        principalTable: "AcademicRanks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObserveSettings_CRNs_CRNId",
                        column: x => x.CRNId,
                        principalTable: "CRNs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ObserveSettings_Colleges_CollegeId",
                        column: x => x.CollegeId,
                        principalTable: "Colleges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObserveSettings_Terms_TermId",
                        column: x => x.TermId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermId = table.Column<int>(nullable: false),
                    CancelReasonId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Members_ApprovedBy",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_CancelReasons_CancelReasonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomSessins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomSessins_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CancelReasonId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomSessins_MemberId",
                table: "CustomSessins",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Members_CollegeId",
                table: "Members",
                column: "CollegeId");

            migrationBuilder.CreateIndex(
                name: "IX_Members_MemberRankId",
                table: "Members",
                column: "MemberRankId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObserveSettings_AcademicRankId",
                table: "ObserveSettings",
                column: "AcademicRankId");

            migrationBuilder.CreateIndex(
                name: "IX_ObserveSettings_CRNId",
                table: "ObserveSettings",
                column: "CRNId");

            migrationBuilder.CreateIndex(
                name: "IX_ObserveSettings_CollegeId",
                table: "ObserveSettings",
                column: "CollegeId");

            migrationBuilder.CreateIndex(
                name: "IX_ObserveSettings_TermId",
                table: "ObserveSettings",
                column: "TermId");
        }
